                ...
                {!isAuthPage && (
                    <div className="flex items-center space-x-3">
                        {currentUser ? (
                            ...
                            <button
                                className="mr-5 py-2 bg-gradient-to-r from-gray-100 to-gray-400 text-gray-700 font-semibold px-4 rounded-full hover:from-gray-200 hover:to-gray-500 transition-all duration-200 transform hover:scale-105"
